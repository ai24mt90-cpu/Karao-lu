...
export default function Footer() {
    return (
        <footer className="w-full border-t border-white/10 bg-black pt-20 pb-12">
            <div className="layout-container">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <p className="text-text-secondary text-[11px] font-medium uppercase tracking-widest leading-loose max-w-xs">
                ...
                <div className="border-t border-white/10 pt-10 text-center">
                    <p className="text-text-secondary/40 text-[9px] font-black uppercase tracking-[0.5em]">
