        ...
        <>
            ...
            <section className="py-6 bg-white border-b border-gray-200 sticky top-0 z-10">
                <div className="layout-container">
                    ...
                    {/* Admin Button */}
                    <a
                        href="https://karaoglu-admin.vercel.app/projeler"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="ml-auto px-4 py-2 bg-primary text-white text-sm font-medium rounded-lg hover:bg-primary-dark transition-colors flex items-center gap-2"
                    >
