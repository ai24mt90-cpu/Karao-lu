                        ...
                        {filteredProjects.map((project) => (
                            ...
                            >
                                <div className="relative aspect-[21/9] overflow-hidden">
                                    ...
                                    <div className="absolute top-6 right-6 px-4 py-2 bg-background/80 backdrop-blur-md text-[10px] font-black uppercase tracking-widest border border-white/20">
                                        {project.status}
                                    </div>
                                </div>
